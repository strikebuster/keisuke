...
public class HTMLRenderer extends AbstractRenderer {
	...
	public byte[] render(DiffFolderResult root) {
		...
		sb.append("<head>\n");
		sb.append("<title>");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_TITLE));
		sb.append("</title>\n");
		...
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_EXPAND));
		sb.append("\">");
		sb.append("<input type=\"button\" onclick=\"hideAll();\" value=\"");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_HIDE));
		sb.append("\">");

		sb.append("<table border=\"1\" width=\"100%\">\n");

		sb.append("<tr><th width=\"80%\">");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_PATH));
		sb.append("</th><th width=\"10%\">");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_STATUS));
		sb.append("</th><th width=\"10%\">");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_INCREASE));
		sb.append("</th><th>");
		sb.append(this.msgdef.getMessage(SCCommonDefine.MSG_DIFF_RND_DECREASE));
		sb.append("</th></tr>\n");
