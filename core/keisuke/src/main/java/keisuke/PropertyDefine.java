...
public class PropertyDefine {
	...
	private final static String DEFAULTPROP = "/keisuke/default.properties";
	...
	public void customizePropertyDefine(String fname) {
	...
	private void setProcProperties(Properties props, String prefix) {
		if (props == null) {
			return;
		}
