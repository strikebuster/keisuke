 ...
 */
public class DiffStatusLabelsImpl implements DiffStatusLabels {
	 ...
	 */
	public DiffStatusLabelsImpl(final MessageDefine msgdef) {
		if (msgdef == null) {
			return;
		}
	 ...
	 */
	public DiffStatusLabelsImpl(final MessageMap map) {
		this.msgmap = map;
		this.setTexts();
	}
	...
	/** {@inheritDoc} */
	public String getLabelOf(final DiffStatusEnum status) {
		if (status == null) {
			return "";
		}
		switch (status) {
